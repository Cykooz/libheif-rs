...
#[test]
fn create_and_encode_monochrome_image() -> Result<(), failure::Error> {
    let width = 640;
    let height = 480;
...
//fn create_and_encode_lossless_image() -> Result<(), failure::Error> {
//    let width = 640;
//    let height = 480;
//
...
#[test]
fn write_test_from_readme_file() -> Result<(), failure::Error> {
    let width = 640;
    let height = 480;
